...
public class Battleship_SERVER
{
	...
	public Battleship_SERVER()
	{
		...
		JLabel label1 = new JLabel("Waiting for client...");
		...
		// TODO add cancel and center hte text
		...
		ChatServer_Panel serverP = new ChatServer_Panel();
		bExit = new JButton("Exit");
		bExit.addActionListener(new ActionListener() 
        {
            public void actionPerformed(ActionEvent e) 
            {
                serverP.closeAndExit();
            }
        });
		playerButtonPanel_.add(bExit);
		
		BorderLayout windowBL = new BorderLayout();
		window_.setTitle("Battleship Server");
		...
		window_.add(serverP.serverPanel_, BorderLayout.EAST);
